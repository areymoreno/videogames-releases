...
function getGamesMonth (appendMonth, initialDate, finishDate, API_KEY) {
    ...
    let requestURL = 'https://api.rawg.io/api/games?key=' + API_KEY + '&dates=' + initialDate + ',' + finishDate + '&page_size=100&ordering=-released&platforms=4';
